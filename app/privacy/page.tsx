...
const CONTACT_EMAIL = 'juni940302@gmail.com';
  ...
  return (
    <main className='mx-auto flex w-full max-w-md flex-col gap-6 px-6 pb-16 pt-12'>
      ...
      <p className='text-[13px] leading-relaxed text-text-sub'>
        오늘수영(이하 ‘서비스’)은 하남 지역 자유수영 정보를 제공하는 비영리 정보
        서비스입니다. 본 방침은 서비스가 이용자의 정보를 어떻게 다루는지
        설명합니다. 시행일: {EFFECTIVE_DATE}.
      </p>
      ...
      <Section title='3. 제보 정보'>
        <p>
          ...
          정확도를 높이기 위한 검수·반영 목적으로만 사용합니다. 제보에는 개인을
          식별할 수 있는 정보를 포함하지 않도록 권장합니다.
        </p>
      </Section>
      ...
      <Section title='7. 방침의 변경'>
        <p>본 방침이 변경되는 경우 본 페이지를 통해 고지합니다.</p>
      </Section>
